          ...
          <div className="flex gap-2">
            <div className="w-2/3">
              ...
              <div className="bg-white pb-28">
                <Title name={"Эцсийн хэрэглээнд гарсан баримтыг буцаах"} />
                <div className="px-14 text-justify">
                  ...
                  суртал чирэгдэлгүй, үйл ажиллагааны ил тод нээлттэй байдлыг
                  хангаж ажиллахыг уриалж байна. "Шүгэл" ажиллагааны хүрээнд
                  зохион байгуулж байгаа НЭГДЬЕ аянд Та ч бас нэгдээрэй.
                </div>
              </div>
            </div>
            <div className="w-1/3">
