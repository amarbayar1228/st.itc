  ...
  return (
    <div className=" ">
      <section className="bg-slate-700 dark:bg-gray-900 ">
        <div className="container h-[90vh]   px-6 py-12 mx-auto lg:flex lg:items-center lg:gap-12 pt-52 lg:pt-0">
          <div className="wf-ull lg:w-1/2">
            <p className="text-sm font-medium text-blue-500 dark:text-blue-400">
              404 error
            </p>
            <h1 className="mt-3 text-2xl font-semibold text-white dark:text-white md:text-3xl">
              Page not found
            </h1>
